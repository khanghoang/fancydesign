...
function SendMail($frommail,$tomail,$subject,$message,$fromfullname)
{
      ...
      $smtp_host ='mail.fancydesign.vn';//Dia chi mail server
      $admin_email = 'info@fancydesign.vn';//User duoc khai bao tren mail server
      $smtp_username = 'info@fancydesign.vn';//User duoc khai bao tren mail server
      $smtp_password = '01227676775';//Pass cua email nay
